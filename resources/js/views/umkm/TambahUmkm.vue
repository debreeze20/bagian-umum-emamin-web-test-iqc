<template>
    <div class="d-flex flex-column flex-root" style="background-color: #DBF4D8;">
        <!--begin::Page-->
                        ...
                        <div id="kt_content_container" class="container-fluid">
                            ...
                            <div class="row d-flex align-items-center mt-5 mb-6">
                                <div class="col-lg-8 align-items-center">
                                  <span class="fw-bolder fs-4">Tambah UMKM</span>&ensp;<a
                                    href="javascript:void(0)"
                                    @click="$router.back()"
                                    class="text-gray-500"
                                    >|&ensp;&ensp;Data UMKM </a
                                  >&ensp;-&ensp; Tambah Data
                                  <h1 style="font-size: 30px !important;" class="py-5  fw-bold">Tambah Data UMKM</h1>
                                </div>
                            ...
                            <div class="card card-flush" id="kt_profile_details_view" >
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    <div class="card-body pt-5">
                                        <div class="row py-3">
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <input class="form-control" type="text" v-model="single.name" placeholder="Nama UMKM"
                                                     autocomplete="off" />
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-white border border-secondary text-gray-600 me-5" @click="reset">Reset Form</button>
                                        <button class="btn " style="background-color: #527D3C;" type="submit"  @click="simpan1()">
    ...
    export default {
        ...
        methods: {  
            initDropzone() {
                ...
                this.dropzoneKtp = new Dropzone("#dropzone-ktp", {
                    url: `/`,
                ...
                this.dropzoneNpwp = new Dropzone("#dropzone-npwp", {
                    url: `/`,
                    dictCancelUpload: "Cancel",
                    maxFilesize: 20,
                    parallelUploads: 100,
                ...
                this.dropzoneNib = new Dropzone("#dropzone-nib", {
                    url: `/`,
                    dictCancelUpload: "Cancel",
                    maxFilesize: 20,
                    parallelUploads: 100,
                ...
                this.dropzoneBankReference = new Dropzone("#dropzone-bank-reference", {
                    url: `/`,
                    dictCancelUpload: "Cancel",
                    maxFilesize: 20,
                    parallelUploads: 100,
        ...
        simpan1(){
            ...
            formData.append('isMbr', this.single.isMbr == true ? 1 : 0);
            ...
            if (!$.isEmptyObject(this.dropzoneKtp.files)) {
                    for (let file in this.dropzoneKtp.files) {
                        formData.append(`fileKtp[${file}]`, this.dropzoneKtp.files[file]);
                    }
                }

            if (!$.isEmptyObject(this.dropzoneNib.files)) {
                    for (let file in this.dropzoneNib.files) {
                        formData.append(`fileNib[${file}]`, this.dropzoneNib.files[file]);
                    }
                }
            if (!$.isEmptyObject(this.dropzoneNpwp.files)) {
                    for (let file in this.dropzoneNpwp.files) {
                        formData.append(`fileNpwp[${file}]`, this.dropzoneNpwp.files[file]);
                    }
                }

            if (!$.isEmptyObject(this.dropzoneBankReference.files)) {
                    for (let file in this.dropzoneBankReference.files) {
                        formData.append(`fileBankReference[${file}]`, this.dropzoneBankReference?.files[file]);
                    }
                }
                this.$loaderShow();
                Api().post(`${this.$apiType('web')}master/umkm`, formData)
                    .then(response => {
                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data UMKM',
                            icon: "success",
                        }).then(result => {
