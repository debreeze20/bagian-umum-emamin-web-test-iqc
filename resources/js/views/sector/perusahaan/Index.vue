    ...
    <div style="background:#fff;min-height:100vh;width:100%" class="pb-12">
        ...
        <template v-else>
            ...
            <div class="d-flex justify-content-center align-items-center flex-column p-5"
                :style="`background: rgba(0, 0, 0, .3) url('${single.detail.background}')`"
                style="background-size:cover;width:100%;background-position:center;min-height:400px;background-blend-mode:darken">
                <div class="fw-bolder text-white text-center" style="font-size:30px">Subsektor {{ single.detail.industrySector.toString() }}</div>
                <div class="fw-bolder text-white text-center" style="font-size:44px">{{single.detail.trademarkName}}
                </div>
            </div>
            <div class="container" style="padding-top:50px">
                <div class="d-flex justify-content-center">
                    <div class="border p-3 mb-5" style="border-radius:15px;max-width:600px">
                        <div class="d-flex justify-content-center flex-wrap">
                            <div @click="flagTab = 'portofolio';getDataPortofolio()"
                                :class="flagTab == 'portofolio' ? 'active' : ''"
                                class="py-3 px-8 c-pointer fw-bolder custom-tab-header">Portfolio Perusahaan
                            </div>
                    ...
                    <template v-else>
                        <div class="row">
                            <div class="col-lg-2 mb-5">
                                <img :src="`${single.detail.logoUrl}`" style="width:120px;height:120px" />
                            </div>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="p-5" style="border:1px dashed #eff2f5!important;border-radius: 5px;">
                            ...
                            <div class="col-lg-12">
                                <div class="border p-5 mb-5" style="border-radius:5px">
                                    ...
                                    <div class="d-flex align-items-center mt-3" v-if="single.detail.website">
                                        <div>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="d-flex align-items-center mt-3" v-if="single.detail.marketingLink">
                                        <div>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="d-flex align-items-center mt-3" v-if="single.detail.twitter">
                                        <div>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="d-flex align-items-center mt-3" v-if="single.detail.facebook">
                                        <div>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="d-flex align-items-center mt-3" v-if="single.detail.instagram">
                                        <div>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <template v-if="flagTab == 'portofolio'">
                    <div class="row mt-5">
                        ...
                        <template v-else>
                            <div class="row mt-5">
                                <div class="col-lg-4 mb-8" v-for="(context, index) in listDataPortofolio">
                                    <div class="w-100 c-pointer" @click="redirectPortofolio(context.id)"
                                        style="background: #FFFFFF;box-shadow: 0px 1px 24px rgba(0, 0, 0, 0.08);height: 100%;">
                                        <img :src="context.industryPortfolioFileCover ? `${context.industryPortfolioFileCover.link}` : ''"
                                            style="width:100%;height:180px;object-position: center;object-fit:cover;border-radius:5px" />
                                        <div class="p-3">
            ...
            getDetail(type) {
                ...
                Api().get(`${this.$apiType('web')}transact/industry/${this.$route.params.id}`)
                    .then(response => {
                        ...
                        this.single.detail.logoUrl = context.industryLogoFile ? context.industryLogoFile.link : '';
                        this.single.detail.background = context.industryFeaturedProductFile ? context
                            .industryFeaturedProductFile.link : '';
